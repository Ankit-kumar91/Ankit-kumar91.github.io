...
const Skills: React.FC = () => {
    ...
    return (
        <Section id="skills" title="Skills & Expertise" subtitle="From bioactivity data and model training through to containerized deployment — and the bench chemistry behind it">
